...
-- 3.1 Users (사용자 기본 정보)
-- Supabase auth.users와 연동되는 확장 프로필
CREATE TABLE users (
...
-- ============================================
-- 이 부분은 Supabase Dashboard에서 수동으로 생성하거나
-- Supabase CLI로 관리할 수 있습니다.
--
-- 필요한 버킷:
-- - avatars: 프로필 사진
-- - documents: 인증 서류
...
-- 순서대로 실행하면 모든 테이블, 인덱스, 트리거, RLS 정책이 생성됩니다.
