            ...
            <CardContent className="p-8">
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 bg-[#0F0F0F] rounded-lg border border-[#2A2A2A]">
                  ...
                  <div>
                    <p className="text-white font-medium">검증된 전문 비서 매칭</p>
                    <p className="text-gray-400 text-sm">엄선된 비서진과 빠른 매칭</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-[#0F0F0F] rounded-lg border border-[#2A2A2A]">
                  ...
                  <div>
                    <p className="text-white font-medium">안전한 결제 시스템</p>
                    <p className="text-gray-400 text-sm">투명하고 신뢰할 수 있는 거래</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-[#0F0F0F] rounded-lg border border-[#2A2A2A]">
                  ...
                  <div>
                    <p className="text-white font-medium">24/7 고객 지원</p>
                    <p className="text-gray-400 text-sm">언제든지 도움을 받으실 수 있습니다</p>
                  </div>
                </div>
